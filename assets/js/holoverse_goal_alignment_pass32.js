(()=>{
  ...
  const VERSION = 'pass34-goal-alignment-no-observer';
  ...
  function installStyle() {
    ...
    style.textContent = `
      ...
      .holo-goal-panel[data-version]::before {
        content: 'HoloVerse public demo goals';
        grid-column: 1 / -1;
  ...
  function ensureTags() {
    ...
    if (!host || host.dataset.goalAligned === VERSION) return;
    host.dataset.goalAligned = VERSION;
    host.innerHTML = '';
